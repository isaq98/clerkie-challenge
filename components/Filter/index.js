        ...
        <div className="filter-container">
            <div className="filter-header">
                ...
                <div className="exit-filter" onClick={() => setVisibilityCallback(false)}>
                    <svg aria-label="exit" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4L13 13" stroke="#424242" strokeWidth="2" strokeLinecap="round"/><path d="M13 4L4 13" stroke="#424242" strokeWidth="2" strokeLinecap="round"/></svg>
                </div>
            </div>
